...
//	assertEquals("Userid gleich","User1",info.getUserId());
	...
	System.out.println(new org.joda.time.Instant(cal.getTimeInMillis()));
	System.out.println(new org.joda.time.Instant(cal.getTimeInMillis() + 1000L * 60L * 60L * 24L * 10000));
